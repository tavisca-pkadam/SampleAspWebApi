...
namespace WebApi1.Services
{
    public class UserService
    {
        ...
        public Response Create(UserModel user)
        {
            ...
            else if (UserValidation.ValidateAddress(user.Address) && UserValidation.ValidateAddress(user.Address)  && UserValidation.ValidateAddress(user.Address)  && validateLastName)
            {
