...
namespace TestWebApi.Data
{
    public class UserServiceFixture
    {
        ...
        public void Test_Create_Returns_RequestDataAndStatus200_On_ValidData()
        {
            ...
            var newUser = new UserModel { Id = 1, FirstName = "Aatif", LastName = "Siddique", Address = "Pune", Age = 18 };
        ...
        public void Test_Update_Returns_RequestDataAndStatus100_On_IncompleteData()
        {
            ...
            var newUser = new UserModel { Id = 1, FirstName = "Aatif", LastName = "", Address = "Pune", Age = 18 };
